...
export function substitute(a: number, b: number, c: number, d: number): number;
export function eval(a: number): number;
export function standard_form(a: number): number;
